...
def run(seed: int = 20260707) -> Dict[str, Any]:
    ...
    return {
        ...
        "limitations": [
            ...
            "Component boundaries are kept modular so later quantum-bond tests can target substructures separately.",
        ],
    }
...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=Path("data/microreactor/information_microreactor_sandbox_seed20260707.json"))
    parser.add_argument("--csv", type=Path, default=Path("data/microreactor/information_microreactor_sandbox_seed20260707_summary.csv"))
