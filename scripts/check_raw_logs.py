...
def main() -> int:
    ...
    try:
        ...
        step3_tmp_json = tmp / "step3_svetlichny_seed0.json"
        step3_tmp_csv = tmp / "step3_svetlichny_seed0_summary.csv"
        run([
            sys.executable,
        ...
        compare_csv(ROOT / "data/quantum_microreactor/step3_svetlichny_seed0_summary.csv", step3_tmp_csv, rtol=args.rtol, atol=args.atol)

        step4_tmp_json = tmp / "step4_population_synergy_seed0.json"
        step4_tmp_csv = tmp / "step4_population_synergy_seed0_summary.csv"
        run([
            sys.executable,
        ...
        compare_csv(ROOT / "data/quantum_microreactor/step4_population_synergy_seed0_summary.csv", step4_tmp_csv, rtol=args.rtol, atol=args.atol)

        step5_tmp_json = tmp / "step5_reactor_like_population_synergy_seed0.json"
        step5_tmp_csv = tmp / "step5_reactor_like_population_synergy_seed0_summary.csv"
        run([
            sys.executable,
        ...
        compare_csv(ROOT / "data/quantum_microreactor/step5_reactor_like_population_synergy_seed0_summary.csv", step5_tmp_csv, rtol=args.rtol, atol=args.atol)

        step6_tmp_json = tmp / "step6_explicit_component_chain_seed0.json"
        step6_tmp_csv = tmp / "step6_explicit_component_chain_seed0_summary.csv"
        run([
            sys.executable,
        ...
        compare_csv(ROOT / "data/quantum_microreactor/step6_explicit_component_chain_seed0_summary.csv", step6_tmp_csv, rtol=args.rtol, atol=args.atol)
